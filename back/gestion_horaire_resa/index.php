    ...
    <section>
        ...
        <div class="container">
            <div class="title-page">
                <h1 class="title">Gestion Des Horaire De Reservation</h1>
            </div>
            <div class="btn-add">
                <button type="button" id="add_button" class="add-btn">Add</button>
            </div>
            <table class="table_data" id="heure_data">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>heure</th>
        ...
        <form method="post" id="member_form" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="horaire">taper une heure</label>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function(){
            ...
            $('#add_button').click(function(){
                ...
                $('#member_form')[0].reset();
                $('.modal-title').text("Ajouter une heure");
                $('#action').val("Add");
                $('#operation').val("Add");
            ...
            var dataTable = $('#heure_data').DataTable({
                    "processing":true,
                    "serverSide":true,
                    "searching": false,
                    "paging": false,
