    ...
    <section>
        ...
        <div class="container">
            <div class="title-page">
                <h1 class="title">Gestion Des Formules</h1>
            </div>
            <div class="btn-add">
                <button type="button" id="add_button" class="add-btn">Add</button>
            </div>
            <table class="table_data" id="formule_data">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>name</th>
        ...
        <form method="post" id="member_form" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"> Ajout Formule</h4>
                </div>
                <div class="modal-body">
                    <label for="name">taper le nom</label>
                    <input type="text" name="name" id="name" >
                    <label for="content">taper le contenue</label>
                    <input type="text" name="content" id="content" >
                    <label for="price">taper le prix</label>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function(){
            ...
            $('#add_button').click(function(){
                ...
                $('#member_form')[0].reset();
                $('.modal-title').text("Ajouter une formule");
                $('#action').val("Add");
                $('#operation').val("Add");                
        });

            // recup des donnée bdd
            var dataTable = $('#formule_data').DataTable({
                    "processing":true,
                    "serverSide":true,
                    "searching": false,
                    "paging": false,
